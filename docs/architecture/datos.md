...
El borrador v2 incluye `modelKey`; instrucciones, habilidades y selección se guardan con la misma versión de concurrencia. El lector acepta un v1 válido como Sonnet 5, sin escribir durante GET ni recortar sus textos por la metadata añadida. La próxima edición usa el formato nuevo. Los borradores nuevos usan Sonnet 4.6; cambiar ese default no reinterpreta un v1 ni modifica borradores guardados. Un modelo conocido pero no disponible sigue siendo legible y guardable; antes de una nueva admisión debe elegirse Sonnet 4.6. Un formato desconocido o corrupto sigue siendo incompatible.
