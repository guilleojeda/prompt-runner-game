...
El único nivel vigente, `principal-puerta-v4` (versión 4), tiene diez tramos: suelo, pozo, suelo, rama, barrera, plataforma y cuatro tramos de suelo. La salida libre está en el apoyo 10 y el límite es de 24 acciones. La barrera está baja en turnos pares y alta en impares; la plataforma es suelo cuando el turno es múltiplo de tres y pozo en los demás. Hay una recompensa de 25 puntos en el apoyo 2 y una llave sin puntos en el 6. **Agarrar objeto** recoge sólo el objeto del apoyo actual; pasar por allí no lo recoge. La llave abre automáticamente la puerta que impide entrar al apoyo 9 desde el 8. Al encontrarla cerrada, el robot puede retroceder hasta la llave y volver; intentar cruzarla no lo derrota, pero consume un turno. En el apoyo 8, el agente ve que la puerta inmediata requiere la llave, sin recibir su ubicación. La observación también indica si mira a izquierda o derecha: empieza mirando a derecha y cada movimiento intentado actualiza esa orientación. Avanzar y Retroceder caminan; Saltar y Agacharse y avanzar reciben dirección; Nadar consume un turno sin mover al robot. Esperar deja pasar un turno sin moverse y permite que cambie el terreno periódico. Las descripciones explican las habilidades al agente, pero no cambian la física.
